 ...
 * @author lattanze
 */
public class InventoryManagerFrame_EPP extends javax.swing.JFrame {

       String versionID = "V1.1";
       String userID;
       String roleID;
    /** Creates new form AddInventoryMainFrame */
    public InventoryManagerFrame_EPP(String userID, String roleID) {
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InventoryManagerFrame_EPP("2","INV_MAN").setVisible(true);
            }
        });
    }
