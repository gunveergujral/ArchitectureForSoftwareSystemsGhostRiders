...
import DataAccessObj.ShippingDAO;
import JavaBeans.Orders;
import UserInterface.OrderFrame;
...
public class ShipFrame extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (!orderBlank) {
            try {
                ...
                orders.setOrderTable(orderID);
                ShippingDAO shipping = new ShippingDAO();
                results = shipping.getInventory(orders);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        // If we are connected, then we update the shipped status
            ...
            try {
                ...
                Orders orders = new Orders();
                orders.setOrderID(updateOrderID);
                ShippingDAO shipping = new ShippingDAO();
                rows = shipping.setShippingStatus(orders);
    ...
    private void getPendingOrders() {
        ...
        jTextField5.setText("");
           ...
           try {
                ...
                ShippingDAO shipping = new ShippingDAO();
                results = shipping.getPendingOrders();
    ...
    private void getShippedOrders() {
        ...
        try {
                ...
                ShippingDAO shipping = new ShippingDAO();
                results = shipping.getShippedOrders();
                //Display the data in the textarea
                jTextArea1.setText("");
